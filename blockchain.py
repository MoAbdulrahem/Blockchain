...
#--------------------------------------------------------------------------#        
def main():
  blockchain = Blockchain(level=4)
  database = ["hello world", "what's up", "hello", "bye", "asdf", "zxczc"]
  ...
  # blockchain.chain[2].position_in_chain = 1

  injected_data = ['injected1',
  'injected2',
  'injected3',
  'injected4',
  'injected5',
  ...
  local_head = blockchain.chain[1]
  for i in injected_data:
  ...
  # head = blockchain.chain_root
  # while head and blockchain.chain:
  #   print(head)
  ...
  # print(blockchain.get_longest_chain_head())
